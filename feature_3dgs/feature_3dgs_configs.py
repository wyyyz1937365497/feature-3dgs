...
feature_3dgs = MethodSpecification(
...
feature_3dgs_speedup = MethodSpecification(
    config=TrainerConfig(
        method_name="feature-3dgs",
        steps_per_eval_image=100,
        steps_per_eval_batch=0,
...
# Dataparser specification for semantic features
from nerfstudio.plugins.registry_dataparser import DataParserSpecification

semantic_feature_dataparser = DataParserSpecification(
